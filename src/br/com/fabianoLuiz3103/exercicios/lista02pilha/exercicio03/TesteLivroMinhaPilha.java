...
public class TesteLivroMinhaPilha {
    ...
    public static void main(String[] args) {
        ...
        while (opcao != 8){
            ...
            switch (opcao){
                ...
                case 5 -> System.out.println("\n *** A PILHA ESTÁ COM " + livros.tamanho() + " LIVROS *** " );
    ...
    private static void ultimoLivro(Pilha<Livro> pilha, boolean desempilha){
        try{
            System.out.println("\n *** LIVRO QUE " + ((desempilha)?"ACABOU DE SER REMOVIDO": "ESTÁ NO TOPO DA PILHA") + " *** " +
                    "\n" + (desempilha?pilha.desempilha():pilha.topo()));
