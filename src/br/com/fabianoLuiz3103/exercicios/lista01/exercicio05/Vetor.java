 ...
 * limpar, onde todos os elementos da lista serão removidos,
 * esse método é semelhante ao clear da classe ArrayList
 */
public class Vetor<T> {
    ...
    */
    ...
    public void clear(){
        /*
        Instânciando um novo vetor para sobrescrever o anterior
