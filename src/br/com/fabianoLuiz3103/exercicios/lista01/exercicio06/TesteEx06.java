package br.com.fabianoLuiz3103.exercicios.lista01.exercicio06;

import br.com.fabianoLuiz3103.exercicios.lista01.exercicio05.Vetor;
 ...
 * --> Insira 30 contatos no vetor usando loop
 * --> Utilize todos os métodos da classe Vetor
 */
public class TesteEx06 {
    ...
    public static void main(String[] args) {
        ...
        Vetor<Contato> agenda = new Vetor<>(20);
        int opcao = 0;
       ...
       while (opcao != 7){
           ...
           switch (opcao){
               ...
               case 2 -> {
                   int indice = receberInteiro(scanner, agenda.tamanho());
                   System.out.println("\n\n\t\t >> ADIÇÃO DE CONTATO NA POSIÇÃO " +indice + " DA AGENDA <<");
                   Contato contato = retornarContatoAdicao(scanner);
                   agenda.adiciona(contato, (indice-1));//-1 porque o vetor vai de [0, tamanho-1]
                   System.out.println(contato + "\n\t ->>> ADICIONADO COM SUCESSO! ");
               }
               ...
               case 3 -> {
                   ...
                   try{
                       Contato c = agenda.get(agenda.busca(contato));
                       if(c!=null){
                           agenda.remove(c);
    ...
    private static void adicionandoContatos(Vetor<Contato> agenda){
